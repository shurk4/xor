...
signals:
    // Запускает таймер для режима определения новых входных файлов по таймеру
    void runTimer(int);
    // Сообщает о завершении работы экземпляра класса
    void finished();
    // Отправляет список новых файлов, если такие имеются
...
public slots:
    ...
    void stop();
    // Проверяет директорию входных файлов на новые файлы
